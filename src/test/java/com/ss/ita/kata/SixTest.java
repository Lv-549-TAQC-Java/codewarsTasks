...
public class SixTest extends SixDataProvider {
    ...
    public void testMean(Six impl, String act, double exp) {
        ...
        double actualData = impl.mean(act, data);
        Assert.assertEquals(exp, actualData,impl.getClass().getName());
    }
    @Test(dataProvider = "dataForVariance")
    public void testVariance(Six impl, String act, double exp) {
        String data = "Rome:Jan 81.2,Feb 63.2,Mar 70.3,Apr 55.7,May 53.0,Jun 36.4,Jul 17.5,Aug 27.5,Sep 60.9,Oct 117.7,Nov 111.0,Dec 97.9" +
                "\n" +
                "London:Jan 48.0,Feb 38.9,Mar 39.9,Apr 42.2,May 47.3,Jun 52.1,Jul 59.5,Aug 57.2,Sep 55.4,Oct 62.0,Nov 59.0,Dec 52.9" +
                "\n" +
                ...
                "\n" +
                "Lima:Jan 1.2,Feb 0.9,Mar 0.7,Apr 0.4,May 0.6,Jun 1.8,Jul 4.4,Aug 3.1,Sep 3.3,Oct 1.7,Nov 0.5,Dec 0.7";
        double actualData = impl.variance(act, data);
        Assert.assertEquals(exp, actualData,impl.getClass().getName());
    }
